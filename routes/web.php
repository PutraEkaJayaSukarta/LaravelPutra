...
//bagian pembelian
Route::get('/index-pembelian', [Pembelian::class, 'index'])->name('index-pembelian');
Route::post('/pembelian-tambah', [Pembelian::class, 'store'])->name('upload-penjualan');

//bagian Penjualan
Route::get('/index-penjualan', [Penjualan::class, 'index'])->name('penjualan-barang'); 


//bagian stok barang
Route::get('/menustok', [StockBarangController::class, 'tampil'])->name('stok');
Route::post('/barang/search', [StockBarangController::class, 'search'])->name('search');
Route::get('/menustok/cari', [StockBarangController::class, 'cari'])->name('mencari');
    //export excel & pdf
    Route::get('/barang/export/excel', [StockBarangController::class, 'viewToExcel'])->name('barang.export.excel');
    // routes/web.php
    Route::get('/export-excel', [StockBarangController::class, 'exportToExcel'])->name('export-excel');


    Route::get('/preview/pdf', [StockBarangController::class, 'previewToPDF'])->name('preview-pdf');
    //tambah stok
    Route::get('/indexstok', [StockBarangController::class, 'tambah'])->name('tambah-stok');
    Route::get('/insertbarang', [StockBarangController::class, 'tambahsantri'] )->name('tambahsantri');
    Route::post('/insertbarang', [StockBarangController::class, 'simpansantri'] )->name('simpansantri');
    //delete
    Route::delete('/stok-barangs/{id}', [StockBarangController::class, 'destroy'])->name('stok-destroy');
    //update
    Route::get('/posts/{id}/edit', [StockBarangController::class, 'edit'])->name('posts-edit');
    Route::put('/posts/{id}', [StockBarangController::class, 'update'])->name('posts-update');
