                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            <?php foreach($menus as $menu){
                                if($menu['id_menu']==32){
                                    ?>
                                        <li class="list-group-item main-menu-item" onClick="location.href='{{route('stok')}}'"> <i class="fa fa-angle-right"></i> Menu Stock Barang</li>  
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            <?php foreach($menus as $menu){
                                if($menu['id_menu']==32){
                                    ?>
                                    <li class="list-group-item main-menu-item" onClick="location.href='{{route('penjualan-barang')}}'"> <i class="fa fa-angle-right"></i> Penjualan Barang</li>  
                                    <?php 
                                }
                            } 
                            ?>
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            <?php foreach($menus as $menu){
                                if($menu['id_menu']==32){
                                    ?>
                                    <li class="list-group-item main-menu-item" onClick="location.href='{{ route('index-pembelian')}}'"> <i class="fa fa-angle-right"></i> Pembelian Barang</li>  
                                    <?php 
                                }
                            } 
                            ?>
